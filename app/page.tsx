      ...
      <RevealSection id="students" className="py-20 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              <div className="p-8">
                <div className="w-12 h-12 bg-blue-50 rounded-lg text-brand-700 flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href="/downloads" className="bg-white p-5 rounded-xl shadow flex items-center gap-4 hover-lift group relative overflow-hidden">
              ...
              />
              <div
                className="w-12 h-12 bg-blue-50 rounded-lg text-brand-700 flex items-center justify-center flex-shrink-0 group-hover:bg-brand-700 group-hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
